  ...
  if (!isConnected) {
    return (
      ...
      <View style={styles.loginArea}>
        <Button
          title={connectLoading ? 'Logging in...' : 'Login with Google'}
          onPress={() =>
            connectTo({
        ...
        />
        <Button
          title={connectLoading ? 'Logging in...' : 'Login with Auth0 Email Passwordless'}
          onPress={() =>
            connectTo({
        ...
        />
        <Button
          title={connectLoading ? 'Logging in...' : 'Login with Auth0 GitHub'}
          onPress={() =>
            connectTo({
              authConnection: AUTH_CONNECTION.CUSTOM,
